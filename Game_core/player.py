...
class Player(pygame.sprite.Sprite):
    ...
    def import_dust_run_particules(self):
        self.dust_run_particules = (r'C:\Users\mouni\Documents\Codes_python\graphics\character\dust_particules\run')
     ...
     #      self.dust_frame_index += self.dust_animation_speed
      #     if self.dust_frame_index >= len(self.dust_run_particules):
       #       self.dust_frame_index = 0
        ...
        #      dust_particules = self.dust_run_particules[int(self.dust_frame_index)]
            
         #  if self.facing_right:
          #    pos = self.rect.bottomleft
           #   self.display_surface.blit(dust_particules, pos)
